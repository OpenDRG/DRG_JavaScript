...
import Grouper_changzhou_2022 from './Grouper_changzhou_2022.js';

var GroupProxy_changzhou_2022=class{
    checkMessages=[];
    ...
    async group_record(record){
        ...
        let result=Grouper_changzhou_2022(record);
...
export {GroupProxy_changzhou_2022 as GroupProxy};