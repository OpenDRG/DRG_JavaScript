...
export default function JA2_1_group(record){
    ...
    let adrg_zd1=[];
    let adrg_ss=["85.4303","85.4300x003","85.4300x004","85.4301","85.4302","85.4401","85.4402","85.4403","85.4500x001","85.4500x003","85.4501","85.4600","85.4700","85.4800"];
    let adrg_ss1=[];
    let adrg_ss2=[];
    let dept_list=[];
    if (true && adrg_zd.includes(record.zdList[0]) && record.ssList && intersect(record.ssList,adrg_ss)){
        putMessage('符合JA2_1入组条件，匹配规则：主诊断匹配、某一手术匹配');
