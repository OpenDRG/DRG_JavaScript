...
export default function NA1_1_group(record){
    ...
    let adrg_zd1=[];
    let adrg_ss=["67.4x00x002","68.4900x006","68.6100x001","68.6100x002","68.6101","68.6900x001","68.6900x001","68.6900x002","68.6901","68.6902","68.7100x001","68.7900x003","68.7901","68.8x01","71.5x00x001","71.5x00x003","71.5x00x004"];
    let adrg_ss1=[];
    let adrg_ss2=[];
    let dept_list=[];
    if (true && adrg_zd.includes(record.zdList[0]) && record.ssList && intersect(record.ssList,adrg_ss)){
        putMessage('符合NA1_1入组条件，匹配规则：主诊断匹配、某一手术匹配');
