...
export default function IF5_group(record){
    let adrg_zd=[];
    let adrg_zd1=[];
    let adrg_ss=["77.0101","77.0102","77.0103","77.0104","77.7101","77.7102","77.8909","78.5900x025","78.6100x004","78.6101","78.6102","78.6103","78.6104","78.6105","78.6106","78.6107","78.6108","78.6201","78.6202","78.6301","78.6302","78.6303","78.6304","78.6401","78.6402","78.6403","78.6404","78.6501","78.6502","78.6600x002","78.6600x003","78.6601","78.6602","78.6701","78.6702","78.6703","78.6704","78.6705","78.6706","78.6800x005","78.6801","78.6802","78.6803","78.6804","78.6900x002","78.6900x008","78.6900x010","78.6900x016","78.6900x017","78.6901","78.6902","78.6903","78.6904","78.6905","78.6906","78.6907","78.6908"];
    let adrg_ss1=[];
    let adrg_ss2=[];
    let dept_list=[];
    if (true && record.ssList && adrg_ss.includes(record.ssList[0]) && record.ssList && intersect(record.ssList,adrg_ss)){
        putMessage('符合IF5入组条件，匹配规则：主手术匹配、某一手术匹配');
        let drg=new MDCI_DRG();
        
        if (drg.IF5A_group(record)){
            return 'IF5A';
        }
