...
import Grouper_haerbin_2022 from './Grouper_haerbin_2022.js';

var GroupProxy_haerbin_2022=class{
    checkMessages=[];
    ...
    async group_record(record){
        ...
        let result=Grouper_haerbin_2022(record);
...
export {GroupProxy_haerbin_2022 as GroupProxy};