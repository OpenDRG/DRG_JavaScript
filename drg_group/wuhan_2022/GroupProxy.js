...
//import Grouper_wuhan_2022 from './Grouper_wuhan_2022.js';

var GroupProxy_wuhan_2022=class{
    checkMessages=[];
    ...
    async group_record(record){
        ...
        const {default:group}=await import('./Grouper_wuhan_2022.js');
        let result=group(record);
        //let result=Grouper_wuhan_2022(record);
...
export {GroupProxy_wuhan_2022 as GroupProxy};