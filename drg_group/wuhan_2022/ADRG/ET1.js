...
export default function ET1_group(record){
    ...
    if (true && adrg_zd.includes(record.zdList[0])){
        ...
        if (drg.ET11_group(record)){
            return 'ET11';
        }        if (drg.ET1B_group(record)){
            return 'ET1B';
        }
        return 'ET1';
    }else{
