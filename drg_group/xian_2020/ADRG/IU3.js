...
export default function IU3_group(record){
    ...
    if (true && adrg_zd.includes(record.zdList[0])){
        ...
        if (drg.IU33_group(record)){
            return 'IU33';
        }

        if (drg.IU35_group(record)){
            return 'IU35';
        }
