...
import Grouper_zhoukou_2023 from './Grouper_zhoukou_2023.js';

var GroupProxy_zhoukou_2023=class{
    checkMessages=[];
    ...
    async group_record(record){
        ...
        if (this.TRANS_CODE){
            ...
            if (status){
                return [record,GroupResult.createResultCheck(status,this.returnMessages(),record)];
            }
        }
        ...
        let result=Grouper_zhoukou_2023(record);
...
export {GroupProxy_zhoukou_2023 as GroupProxy};