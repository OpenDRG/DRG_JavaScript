...
export default function IC3_group(record){
    ...
    if (true && record.ssList && adrg_ss.includes(record.ssList[0])){
        ...
        if (drg.IC31_group(record)){
            return 'IC31';
        }

        if (drg.IC33_group(record)){
            return 'IC33';
        }

        if (drg.IC35_group(record)){
            return 'IC35';
        }
