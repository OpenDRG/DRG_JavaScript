...
export default function OE1_group(record){
    ...
    if (true && adrg_zd.includes(record.zdList[0]) && record.ssList && adrg_ss.includes(record.ssList[0])){
        ...
        if (drg.OE11_group(record)){
            return 'OE11';
        }

        if (drg.OE13_group(record)){
            return 'OE13';
        }

        if (drg.OE15_group(record)){
            return 'OE15';
        }
