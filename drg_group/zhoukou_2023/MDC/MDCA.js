...
import AH1_group from '../ADRG/AH1.js';

export default function MDCA_group(record){
    let mdc_zd=[];
    let dept_list=[];
    if (!(true && record.ssList && record.ssList && (SS_VALID.includes(record.ssList[0]) || ["96.0400","96.7201"].includes(record.ssList[0])))){
        return '';
    }
