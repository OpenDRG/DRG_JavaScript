...
export default function FP1_group(record){
    ...
    let adrg_zd1=[];
    let adrg_ss=["37.6101","37.6600x001","37.6800x001","37.6800x002","37.6800x003","37.6800x004","37.6800x005","39.9500x004","39.9500x005","39.9500x006","39.9500x007","39.9501","39.9600x002","39.9600x003","96.7101"];
    let adrg_ss1=[];
    let dept_list=[];
