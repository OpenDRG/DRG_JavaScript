...
export default function WR1_1_group(record){
    ...
    if (true && adrg_zd.includes(record.zdList[0])){
        putMessage('符合WR1_1入组条件，匹配规则：主诊断匹配');
