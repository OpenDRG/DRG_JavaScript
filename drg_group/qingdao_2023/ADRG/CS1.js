...
export default function CS1_group(record){
    ...
    if (true && adrg_zd.includes(record.zdList[0])){
        ...
        if (drg.CS11_group(record)){
            return 'CS11';
        }

        if (drg.CS13_group(record)){
            return 'CS13';
        }

        if (drg.CS15_group(record)){
            return 'CS15';
        }
