...
import Grouper_qingdao_2023 from './Grouper_qingdao_2023.js';

var GroupProxy_qingdao_2023=class{
    checkMessages=[];
    ...
    async group_record(record){
        ...
        let result=Grouper_qingdao_2023(record);
...
export {GroupProxy_qingdao_2023 as GroupProxy};