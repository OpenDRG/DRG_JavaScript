...
import Grouper_wlmq_2022 from './Grouper_wlmq_2022.js';

var GroupProxy_wlmq_2022=class{
    checkMessages=[];
    ...
    async group_record(record){
        ...
        let result=Grouper_wlmq_2022(record);
...
export {GroupProxy_wlmq_2022 as GroupProxy};