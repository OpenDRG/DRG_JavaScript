...
export default function SU1_group(record){
    ...
    if (true && adrg_zd.includes(record.zdList[0])){
        ...
        if (drg.SU1AA_group(record)){
            return 'SU12A';
        }

        if (drg.SU15A_group(record)){
            return 'SU15A';
        }

        if (drg.SU13B_group(record)){
            return 'SU13B';
        }

        if (drg.SU15B_group(record)){
            return 'SU15B';
        }

        if (drg.SU11B_group(record)){
            return 'SU11B';
        }
