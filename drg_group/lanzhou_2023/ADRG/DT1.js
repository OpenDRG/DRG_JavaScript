...
export default function DT1_group(record){
    ...
    if (true && adrg_zd.includes(record.zdList[0])){
        ...
        if (drg.DT1AA_group(record)){
            return 'DT12A';
        }

        if (drg.DT1AB_group(record)){
            return 'DT12B';
        }

        if (drg.DT15A_group(record)){
            return 'DT15A';
        }

        if (drg.DT15B_group(record)){
            return 'DT15B';
        }
