...
import Grouper_lanzhou_2023 from './Grouper_lanzhou_2023.js';

var GroupProxy_lanzhou_2023=class{
    checkMessages=[];
    ...
    async group_record(record){
        ...
        let result=Grouper_lanzhou_2023(record);
...
export {GroupProxy_lanzhou_2023 as GroupProxy};