...
import Grouper_fuzhou_2022 from './Grouper_fuzhou_2022.js';

var GroupProxy_fuzhou_2022=class{
    checkMessages=[];
    ...
    async group_record(record){
        ...
        let result=Grouper_fuzhou_2022(record);
...
export {GroupProxy_fuzhou_2022 as GroupProxy};