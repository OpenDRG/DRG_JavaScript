...
export default function HS3_group(record){
    ...
    if (true && adrg_zd.includes(record.zdList[0])){
        ...
        if (drg.HS31_group(record)){
            return 'HS31';
        }        if (drg.HS3B_group(record)){
            return 'HS3B';
        }
        return 'HS3';
    }else{
