...
import Grouper_yantai_2023 from './Grouper_yantai_2023.js';

var GroupProxy_yantai_2023=class{
    checkMessages=[];
    ...
    async group_record(record){
        ...
        let result=Grouper_yantai_2023(record);
...
export {GroupProxy_yantai_2023 as GroupProxy};