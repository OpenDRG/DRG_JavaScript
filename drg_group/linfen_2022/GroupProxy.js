...
import Grouper_linfen_2022 from './Grouper_linfen_2022.js';

var GroupProxy_linfen_2022=class{
    checkMessages=[];
    ...
    async group_record(record){
        ...
        let result=Grouper_linfen_2022(record);
...
export {GroupProxy_linfen_2022 as GroupProxy};