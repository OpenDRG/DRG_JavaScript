...
import Grouper_zhejiang_2022 from './Grouper_zhejiang_2022.js';

var GroupProxy_zhejiang_2022=class{
    checkMessages=[];
    ...
    async group_record(record){
        ...
        let result=Grouper_zhejiang_2022(record);
...
export {GroupProxy_zhejiang_2022 as GroupProxy};