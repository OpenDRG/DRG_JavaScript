...
export default function LL1_group(record){
    let adrg_zd=[];
    let adrg_zd1=[];
    let adrg_ss=["39.9500x005","39.9500x006","39.9500x007","39.9501","39.9600x002","39.9600x003","39.9700x001","39.9701","39.9702","39.9703","39.9704","39.9705","54.9800","54.9800x005","54.9800x006","54.9800x007","54.9800x008","39.9500"];
    let adrg_ss1=[];
    let adrg_ss2=[];
    let dept_list=[];
