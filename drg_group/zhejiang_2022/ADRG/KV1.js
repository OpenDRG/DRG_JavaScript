...
export default function KV1_group(record){
    ...
    if (true && adrg_zd.includes(record.zdList[0]) && (!record.ssList || !SS_VALID.includes(record.ssList[0]))){
        ...
        if (drg.KV13_group(record)){
            return 'KV13';
        }

        if (drg.KV15_group(record)){
            return 'KV15';
        }
