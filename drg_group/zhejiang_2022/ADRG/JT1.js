...
export default function JT1_group(record){
    ...
    if (true && adrg_zd.includes(record.zdList[0])){
        ...
        if (drg.JT11_group(record)){
            return 'JT11';
        }

        if (drg.JT13_group(record)){
            return 'JT13';
        }
