...
export default function FE1_group(record){
    ...
    if (true && record.ssList && intersect(record.ssList,adrg_ss)){
        ...
        if (drg.FE13_group(record)){
            return 'FE13';
        }

        if (drg.FE15_group(record)){
            return 'FE15';
        }
