...
export default function JB3_group(record){
    let adrg_zd=[];
    let adrg_zd1=[];
    let adrg_ss=["40.1900x002","40.2200","85.0x00x002","85.0x00x003","85.0x01","85.0x02","85.1100x003","85.1200x001","85.2500","85.8100","85.9100","85.9300","85.9400","85.9500","85.9600","85.9900"];
    let adrg_ss1=[];
    let dept_list=[];
    
    if (true && record.ssList && intersect(record.ssList,adrg_ss)){
        putMessage('符合JB3入组条件，匹配规则：某一手术匹配');
