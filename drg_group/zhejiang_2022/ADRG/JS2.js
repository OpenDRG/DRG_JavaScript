...
export default function JS2_group(record){
    ...
    if (true && adrg_zd.includes(record.zdList[0])){
        ...
        if (drg.JS21_group(record)){
            return 'JS21';
        }

        if (drg.JS23_group(record)){
            return 'JS23';
        }

        if (drg.JS25_group(record)){
            return 'JS25';
        }
