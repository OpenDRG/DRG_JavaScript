...
import Grouper_suzhou_2023 from './Grouper_suzhou_2023.js';

var GroupProxy_suzhou_2023=class{
    checkMessages=[];
    ...
    async group_record(record){
        ...
        let result=Grouper_suzhou_2023(record);
...
export {GroupProxy_suzhou_2023 as GroupProxy};