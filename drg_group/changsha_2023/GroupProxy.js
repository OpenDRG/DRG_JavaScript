...
import Grouper_changsha_2023 from './Grouper_changsha_2023.js';

var GroupProxy_changsha_2023=class{
    checkMessages=[];
    ...
    async group_record(record){
        ...
        let result=Grouper_changsha_2023(record);
...
export {GroupProxy_changsha_2023 as GroupProxy};