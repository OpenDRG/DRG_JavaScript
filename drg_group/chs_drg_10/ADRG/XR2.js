...
export default function XR2_group(record){
    ...
    if (true && adrg_zd.includes(record.zdList[0])){
        ...
        if (drg.XR21_group(record)){
            return 'XR21';
        }

        if (drg.XR23_group(record)){
            return 'XR23';
        }
