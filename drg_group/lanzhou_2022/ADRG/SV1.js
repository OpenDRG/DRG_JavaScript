...
export default function SV1_group(record){
    ...
    if (true && adrg_zd.includes(record.zdList[0])){
        ...
        if (drg.SV11A_group(record)){
            return 'SV11A';
        }

        if (drg.SV11B_group(record)){
            return 'SV11B';
        }

        if (drg.SV13A_group(record)){
            return 'SV13A';
        }

        if (drg.SV13B_group(record)){
            return 'SV13B';
        }

        if (drg.SV15A_group(record)){
            return 'SV15A';
        }

        if (drg.SV15B_group(record)){
            return 'SV15B';
        }
