...
export default function GW1_group(record){
    ...
    if (true && adrg_zd.includes(record.zdList[0])){
        ...
        if (drg.GW1AA_group(record)){
            return 'GW12A';
        }

        if (drg.GW1AB_group(record)){
            return 'GW12B';
        }

        if (drg.GW15A_group(record)){
            return 'GW15A';
        }

        if (drg.GW15B_group(record)){
            return 'GW15B';
        }
