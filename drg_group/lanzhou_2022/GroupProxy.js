...
import Grouper_lanzhou_2022 from './Grouper_lanzhou_2022.js';

var GroupProxy_lanzhou_2022=class{
    checkMessages=[];
    ...
    async group_record(record){
        ...
        let result=Grouper_lanzhou_2022(record);
...
export {GroupProxy_lanzhou_2022 as GroupProxy};